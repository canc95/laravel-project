          ...
          <div class="card-body no-border no-padding pt-5">
            <div class="row">
              <div class="col-md-12">
                ...
                @guest
                  <h6 class="text-uppercase text-center"><a href="{{ route('register') }}" class="nav-link"> <span class="text-uppercase text-danger"><u class="font-weight-bold">Sign in</u></span> for see the contact number</a></h6>
                  @else
